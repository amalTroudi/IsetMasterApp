class DemandesController < ApplicationController
    ...
    def index
      ...
      def update
        ...
        if post_params[:status] == "refusé" || post_params[:status] == "encours" || post_params[:status] == 2 || post_params[:status] == 0
        ...
        elsif post_params[:status] == "accepté" || post_params[:status] == 1
